...
if __name__ == '__main__':
    ...
    words_5 = get_words_limited(sample)

    train_set = train_data[:int(0.7*len(train_data))]
    test_set = train_data[int(0.7*len(train_data)):]

    classifier = NaiveBayes(get_words_limited)
    ...
    for test_sample in test_set:
        ...
        class1 = classifier.classify_document(test_sample[0])
