...
if __name__ == '__main__':
    ...
    votes_class0, votes_class1, votes_class2 = 0, 0, 0
    ...
    final_predictions = sorted(list(votes.items()), key=lambda x: x[1],
                        reverse=True)


    if final_predictions[0][1] == final_predictions[1][1]:
        print('unknown')
    else:
        final_class = final_predictions[0][0]
        print(final_class)
